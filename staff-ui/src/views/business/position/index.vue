    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['business:position:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['business:position:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
...
<!--      <el-col :span="1.5">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="职位名" prop="positionName">
          <el-input v-model="form.positionName" placeholder="请输入职位名" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('business/position/export', {
        ...this.queryParams
